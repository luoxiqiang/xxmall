...
import per.xxmall.common.bean.PicUploadResult;
import per.xxmall.manage.service.PropertyService;
...
public class PicUploadController {
    ...
    public String upload(@RequestParam("uploadFile") MultipartFile uploadFile, HttpServletResponse response)
        ...
        // 生成图片的绝对引用地址
        String picUrl = StringUtils.replace(StringUtils.substringAfter(filePath, propertyService.IMAGE_PATH),
                "\\", "/");
        fileUploadResult.setUrl(propertyService.IMAGE_URL + picUrl);
    ...
    private String getFilePath(String sourceFileName) {
        String baseFolder = propertyService.IMAGE_PATH + File.separator + "images";
