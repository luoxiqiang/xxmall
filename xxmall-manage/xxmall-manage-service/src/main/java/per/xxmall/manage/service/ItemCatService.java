...
import per.xxmall.common.bean.ItemCatData;
...
public class ItemCatService extends BaseService<ItemCat>{
	...
	private static final String KEY = "XXMALL_MANAGE_ITEM_CAT_ALL";
	
	private static final Integer LIFE_TIME = 60*60*24*30*3;
	...
	public ItemCatResult queryAllToTree() {
		...
		try {
			redisService.set(KEY, MAPPER.writeValueAsString(result), LIFE_TIME);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return result;
